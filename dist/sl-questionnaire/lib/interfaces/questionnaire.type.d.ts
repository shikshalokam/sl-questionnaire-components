...
export interface PageQuestion extends Omit<Question, 'responseType' | 'pageQuestions'> {
    value: 'pageQuestions';
    pageQuestions: Question[];
}
export interface MatrixQuestion extends Omit<Question, 'responseType' | 'instanceQuestions' | 'value'> {
    responseType: 'matix';
...
export declare type FileUnion = FileClass | string;
...
export declare type VisibleIfUnion = VisibleIfElement[] | string;
